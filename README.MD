...
- Config your own `HOMEUSER` and `ATTACKERURL` at the very top of the `lazyrecon-main.sh`.
- Update `url` in `discord-hook.sh`
...
25. [ssrf-headers-tool](https://github.com/m4ll0k/Bug-Bounty-Toolz/blob/master/ssrf.py)
