...
third_party_go_dependencies(){
    ...
    gotools[3]="go install -v github.com/projectdiscovery/mapcidr/cmd/mapcidr@latest"
    gotools[4]="go install -v github.com/projectdiscovery/httpx/cmd/httpx@latest"
    gotools[5]="go install -v github.com/projectdiscovery/dnsx/cmd/dnsx@latest"
    ...
    gotools[12]="go install github.com/lc/gau/v2/cmd/gau@latest"
